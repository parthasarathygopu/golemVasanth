...
import {Layers, Lock as LockIcon, Plus, Search, Settings} from "lucide-react";
...
const APICard = ({name, version, routes}: APICardProps) => {
    ...
    return (
        <Card className="transition-all hover:shadow-lg hover:shadow-border/75 duration-150 w-full group cursor-pointer"
